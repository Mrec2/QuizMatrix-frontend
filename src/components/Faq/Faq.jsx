      ...
      <main className={styles.faqMain}>
        <section className={styles.faqSection}>
          <h2 className={styles.faqH2}>
            Pregunta 1: ¿Qué temas de programación están cubiertos en la
            plataforma?
          </h2>
        ...
        <section className={styles.faqSection}>
          <h2 className={styles.faqH2}>Pregunta 2: ¿Cómo puedo acceder a los quizzes?</h2>
          <p className={styles.faqP}>
        ...
        <section className={styles.faqSection}>
          <h2 className={styles.faqH2}>Pregunta 3: ¿Son los quizzes gratuitos?</h2>
          <p className={styles.faqP}>
        ...
        <section className={styles.faqSection}>
          <h2 className={styles.faqH2}>Pregunta 4: ¿Hay límite de intentos para resolver un quiz?</h2>
          <p className={styles.faqP}>
        ...
        <section className={styles.faqSection}>
          <h2 className={styles.faqH2}>
            Pregunta 5: ¿Puedo crear y compartir mis propios quizzes en la
            plataforma?
          </h2>
          <p className={styles.faqP}>
        ...
        <section className={styles.faqSection}>
          <h2 className={styles.faqH2}>Pregunta 6: ¿Cómo puedo contactar al equipo de soporte?</h2>
          <p className={styles.faqP}>
        ...
        <section className={styles.faqSection}>
          <h2 className={styles.faqH2}>Pregunta 7: ¿Qué nivel de dificultad tienen los quizzes?</h2>
          <p className={styles.faqP}>
        ...
        <section className={styles.faqSection}>
          <h2 className={styles.faqH2}>
            Pregunta 8: ¿Se proporcionan respuestas explicativas después de
            resolver un quiz?
          </h2>
          <p className={styles.faqP}>
        ...
        <section className={styles.faqSection}>
          <h2 className={styles.faqH2}>
            Pregunta 9: ¿Es necesario tener conocimientos previos de
            programación para utilizar la plataforma?
          </h2>
          <p className={styles.faqP}>
        ...
        <section className={styles.faqSection}>
          <h2 className={styles.faqH2}>
            Pregunta 10: ¿Se proporciona retroalimentación sobre el desempeño en
            los quizzes?
          </h2>
          <p className={styles.faqP}>
